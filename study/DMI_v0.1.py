...
def main():
    ...
    filenames = file_name_p(os.path.dirname(os.path.realpath(__file__))+'\\logs', '.txt')
    print(filenames)
    print(os.path.dirname(os.path.realpath(__file__))+'\\logs\\')
    for filename in filenames:
        filename = os.path.dirname(os.path.realpath(__file__))+'\\logs\\'+filename
